...
const MandalaCorners = lazy(() => import('./components/shared/MandalaCorners.jsx').then((mod) => ({ default: mod.MandalaCorners })))
...
const bookingPrompts = [
  ...
  { key: 'celebration', label: 'What kind of celebration are you dreaming of?', placeholder: 'Select your celebration style', type: 'select', options: ['Intimate & Romantic', 'Grand & Elegant', 'Destination Paradise', 'Cultural Heritage', 'Modern Minimalist'] },
  { key: 'story', label: 'Tell us about your story...', placeholder: 'Share the essence of your day, your vision, the mood you\'re dreaming of...', type: 'textarea' },
]
...
function SplashScreen() {
  return (
    <motion.div className="fixed inset-0 z-50 flex items-center justify-center bg-[#f6f1e8]" initial={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.8 }}>
      <div className="absolute inset-0">
        <video autoPlay muted loop playsInline preload="metadata" poster={mediaLibrary.splash.poster} className="h-full w-full object-cover opacity-[0.24]">
          <source src={mediaLibrary.splash.video} type="video/mp4" />
        </video>
        <div className="absolute inset-0 bg-[#f6f1e8c4]" />
      </div>
      <motion.div className="relative z-10 px-6 text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.4 }}>
        <p className="mb-3 text-xs tracking-[0.28em] text-[#8b7864]"></p>
        ...
        {/* <button onClick={onSkip} className="mt-8 border border-[#b7a07f66] px-5 py-2 text-xs tracking-[0.2em] text-[#2a2622]"> */}
          {/* Skip */}
        {/* </button> */}
      </motion.div>
    </motion.div>
  ...
  return (
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between border border-[#f2ede37a] bg-[#1111111a] px-4 py-3 backdrop-blur-[2px] md:px-6">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#stories" className="cursor-pointer text-[#111111] hover:text-[#8b7864] transition-colors duration-300">
              Stories
            </a>
            <a href="#films" className="cursor-pointer text-[#111111] hover:text-[#8b7864] transition-colors duration-300">
              Films
            </a>
            <a href="#mosaic" className="cursor-pointer text-[#111111] hover:text-[#8b7864] transition-colors duration-300">
              Editorial
            </a>
            <a href="#mosaic" className="cursor-pointer text-[#111111] hover:text-[#8b7864] transition-colors duration-300">
              Journal
            </a>
            <a href="#begin" className="cursor-pointer text-[#111111] hover:text-[#8b7864] transition-colors duration-300">
              Contact
            </a>
          </div>
        </div>
      ...
      >
        <div className="mx-auto flex w-full max-w-7xl items-end justify-between">
          <div>
            <p className="text-[10px] tracking-[0.24em] text-[#f0e9dc]"></p>
            <h1 className="mt-2 text-4xl leading-none text-[#f9f2e6] md:text-6xl"></h1>
          </div>
      ...
      {showSplash ? (
        ...
        <section className="relative px-5 py-28 md:px-12 md:py-36">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-10 grid gap-3 md:grid-cols-12">
              <h3 className="text-3xl md:col-span-5 md:text-4xl">Where Emotion Becomes Cinema</h3>
        ...
        <section id="films" className="relative px-5 py-28 md:px-12 md:py-36">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-10 max-w-2xl">
              <h3 className="section-title text-4xl md:text-5xl">Crafted With Soul</h3>
              <p className="section-copy">
                Presented like cinema posters, each film is cut as an heirloom.
              </p>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              {mediaLibrary.films.map((film) => (
                <motion.article key={film.title} whileHover={{ opacity: 0.94 }} transition={{ duration: 0.35 }} className="space-y-4">
                  <Suspense fallback={<div className="h-[70vh] bg-[#f4ebe0]" />}>
                    <EditorialVideoCard
                      item={{ ...film, id: film.title }}
                      activeVideoId={activeVideoId}
                      setActiveVideoId={setActiveVideoId}
                      className="h-[70vh]"
                    />
                  ...
                  <div className="flex items-center justify-between border-t border-[#b7a07f50] pt-3">
                    ...
                    <span className="border border-[#b7a07f70] px-3 py-1 text-[10px] tracking-[0.18em] text-[#2a2622]">{film.runtime}</span>
                  </div>
                </motion.article>
              ))}
            </div>
        ...
        <section id="stories" className="relative px-5 py-28 md:px-12 md:py-36">
          <div className="mx-auto max-w-7xl space-y-14">
            ...
            <div className="max-w-2xl">
              <h3 className="text-4xl md:text-5xl">Stories Woven In Light</h3>
              <p className="section-copy">
                Couple narratives written through place, ritual, and atmosphere.
              </p>
            </div>
            {mediaLibrary.stories.map((story, index) => (
              <div key={story.title} className={`grid gap-5 md:grid-cols-12 ${index % 2 ? 'md:[&>*:first-child]:order-last' : ''}`}>
                ...
                <div className="self-end md:col-span-4">
                  ...
                  <h4 className="mt-2 text-2xl">{story.title}</h4>
                  <p className="section-copy">
                    {index === 0 ? 'An intimate celebration beneath the Tuscan sun.' : 'A candlelit evening of vows and quiet joy.'}
                  </p>
                </div>
              </div>
            ))}
        ...
        <section className="relative px-5 py-28 md:px-12 md:py-36">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-10 grid gap-3 md:grid-cols-12">
              <h3 className="text-3xl md:col-span-5 md:text-4xl">An Heirloom Of Memories</h3>
              <p className="max-w-md section-copy md:col-span-7 md:justify-self-end">
        ...
        <section className="relative px-5 py-28 md:px-12 md:py-36">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-10 max-w-2xl">
              <h3 className="text-4xl md:text-5xl">A Living Editorial Archive</h3>
              <p className="section-copy">
        ...
        {/* Large Editorial Image Section */}
        <section className="relative px-5 py-28 md:px-12 md:py-36">
          <div className="mx-auto max-w-7xl">
            <EditorialImage
              image={mediaLibrary.booking.image}
              alt="Luxury wedding editorial ending"
        ...
        <footer className="relative footer-panel border-t border-[#b7a07f40] px-5 py-16 md:px-12 md:py-20">
          <div className="mx-auto flex max-w-7xl flex-col gap-10 md:flex-row md:justify-between">
            ...
            <div className="grid gap-2 text-sm text-[#2a2622]">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-[#8b7864] transition-colors">Instagram</a>
              <a href="mailto:hello@aathmanstudios.com" className="hover:text-[#8b7864] transition-colors">hello@aathmanstudios.com</a>
              <p className="text-xs">India | Europe | Worldwide</p>
              <p className="text-xs">+91 98765 43210</p>
            </div>
            <nav className="flex flex-col gap-2 text-sm text-[#2a2622]">
              <a href="#stories" className="hover:text-[#8b7864] transition-colors">Stories</a>
              <a href="#films" className="hover:text-[#8b7864] transition-colors">Films</a>
              <a href="#begin" className="hover:text-[#8b7864] transition-colors">Contact</a>
            </nav>
          </div>
        </footer>

        {/* Cinematic Contact / Booking Experience */}
        <section id="begin" className="relative overflow-hidden px-5 py-20 md:px-12 md:py-28">
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            >
              ...
              <h3 className="mt-3 text-3xl md:text-4xl text-[#111111]">Where does your forever begin?</h3>
              ...
              {status === 'success' ? (
                ...
                >
                  <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-lg text-[#2a2622] leading-relaxed mb-8">And we cannot wait to frame it forever.</p>
                    <p className="text-sm text-[#8b7864]">We'll respond within 24 hours with our vision for your story.</p>
                  </div>
                </motion.div>
              ) : (
                <motion.div
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        <div className="text-center mb-8">
                          <h4 className="text-2xl md:text-3xl text-[#111111] mb-2">{currentPrompt.label}</h4>
                        ...
                        <form onSubmit={submitInquiry} className="space-y-8">
                          <div className="max-w-md mx-auto">
                            {currentPrompt.type === 'textarea' ? (
                              <textarea
                                ...
                                onChange={(event) => setFormData((prev) => ({ ...prev, [currentPrompt.key]: event.target.value }))}
                                className="w-full px-4 py-3 bg-transparent border-b border-[#8b7864]/50 focus:border-[#8b7864] text-[#111111] placeholder-[#8b7864]/70 transition-colors duration-300 text-lg leading-relaxed resize-none"
                              ...
                              <select
                                ...
                                value={formData[currentPrompt.key]}
                                onChange={(event) => setFormData((prev) => ({ ...prev, [currentPrompt.key]: event.target.value }))}
                                className="w-full px-4 py-3 bg-transparent border-b border-[#8b7864]/50 focus:border-[#8b7864] text-[#111111] transition-colors duration-300 text-lg"
                              >
                                <option value="" disabled>{currentPrompt.placeholder}</option>
                              ...
                              <input
                                ...
                                value={formData[currentPrompt.key]}
                                onChange={(event) => setFormData((prev) => ({ ...prev, [currentPrompt.key]: event.target.value }))}
                                className="w-full px-4 py-3 bg-transparent border-b border-[#8b7864]/50 focus:border-[#8b7864] text-[#111111] placeholder-[#8b7864]/70 transition-colors duration-300 text-lg"
                                placeholder={currentPrompt.placeholder}
                              />
                            )}
                          </div>
                          ...
                          <div className="flex items-center justify-between pt-8">
                            <p className="text-xs tracking-[0.18em] text-[#8b7864]">{step + 1} of {bookingPrompts.length}</p>
                            <motion.button
                              type="submit"
                            ...
                            >
                              {status === 'loading' ? 'Sending...' : isFinalStep ? 'Begin The Journey' : 'Continue'}
                            </motion.button>
                          </div>
                          {status === 'error' && (
                            <motion.p
                            ...
                            >
                              Please set a valid Formspree endpoint.
                            </motion.p>
                          )}
                        </form>
                      </motion.div>
